...
An r of .62 could be considered a moderately strong relationshiop, interesting enough in this case to do some further reporting.
...
# We see a general trend here.  The lower the median household income, the larger number of pills per person shipped to that county.
...
# Something of a trend here. The graph indicates a negative relationship between median household income and pill shipments: the higher the income, the lower the pill shipment rate, and vice versa. But there are exceptions.  
...
# The result is a statistically signficiant (p < .05) weak (r = -.30) negative relationship.  Would need to do some more reporting to flesh this out.
